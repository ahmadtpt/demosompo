...
import com.sompo.demo.service.UserService;
...
public class UserController {
    ...
    @DeleteMapping(path = "/api/unreg/{username}", produces = MediaType.APPLICATION_JSON_VALUE)
    public WebResponse<String> delete(User user, @PathVariable("username") String username) {
        userService.unreg(user, username);
        return WebResponse.<String>builder().data("OK").build();
    }
